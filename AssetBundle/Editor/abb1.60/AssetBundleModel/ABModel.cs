...
using AssetX.Abb160.AssetBundleDataSource;

namespace AssetX.Abb160.AssetBundleModel
{
    /// <summary>
    ...
    public static class Model
    {
        ...
        private static bool s_bBundleChanged = false;
        internal static Action OnBundleChanged { get; set; }
        ...
        internal static BundleFolderInfo CreateNamedBundleFolder(BundleFolderConcreteInfo folder)
        {
            BundleNameData nameData = new BundleNameData(folder.m_Name.bundleName, "dummy");
            return AddFoldersToBundle(s_RootLevelBundles, nameData);
        }
