...
namespace AssetX.Abb160
{
    ...
    {
        protected AssetBundleManageTab m_Controller;
        protected bool m_ContextOnItem = false;
        protected List<UnityEngine.Object> m_EmptyObjectList = new List<UnityEngine.Object>();
        ...
        protected virtual void ForceReloadData(object context)
        {
        ...
        protected virtual void CreateFolderUnderParent(AssetBundleModel.BundleFolderConcreteInfo folder)
        {
        ...
        protected virtual void CreateBundleUnderParent(AssetBundleModel.BundleFolderInfo folder)
        {
        ...
        protected virtual void CreateVariantUnderParent(AssetBundleModel.BundleVariantFolderInfo folder)
        {
            if (folder != null)
            {
        ...
        protected virtual void ConvertToVariant(object context)
        {
            var selectedNodes = context as List<AssetBundleModel.BundleTreeItem>;
            if (selectedNodes.Count == 1)
            {
        ...
        protected virtual void DedupeBundles(object context, bool onlyOverlappedAssets)
        {
            var selectedNodes = context as List<AssetBundleModel.BundleTreeItem>;
        ...
        protected virtual void DeleteBundles(object b)
        {
        ...
        protected class DragAndDropData
        {
        ...
        protected void ReloadAndSelect(int hashCode, bool rename)
        {
            var selection = new List<int>();
