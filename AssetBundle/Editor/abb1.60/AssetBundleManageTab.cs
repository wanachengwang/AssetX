...
namespace AssetX.Abb160
{
    ...
    internal class AssetBundleManageTab 
    {
        ...
        internal void ShowNotification(GUIContent notification)
        {
            m_Parent.ShowNotification(notification);
        }
        ...
        internal void OnGUI(Rect pos)
        {
            ...
            if(m_BundleTree == null)
            {
                ...
                // Use AssetBundleTreeNew to make only deps folder operable. 
                //m_AssetList = new AssetListTree(m_AssetListState, m_AssetListMCHState, this);
                m_AssetList = new AssetListTreeNew(m_AssetListState, m_AssetListMCHState, this);
                m_AssetList.Reload();
                ...
                m_BundleTree = new AssetBundleTreeNew(m_BundleTreeState, this);
